...
exports.default = {
    ...
    methods: {
        submit: function submit() {
            ...
            this.$http.post(baseUrl + '/api/posts/' + this.post + '/comment', { body: this.body }).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/home/james8/public_html/lebook/resources/assets/js/components/comment-form.vue"
...
},{"vue":30,"vue-hot-reload-api":3,"vueify-insert-css":31}],34:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n")
'use strict';
...
exports.default = {
    ...
    directives: {
        dateshow: function dateshow(value) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/james8/public_html/lebook/resources/assets/js/components/comment.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":30,"vue-hot-reload-api":3,"vueify-insert-css":31}],35:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        showLikesModal: function showLikesModal() {
        ...
        showCommentsModal: function showCommentsModal() {
        ...
        deletePost: function deletePost() {
            ...
            this.$http.delete(baseUrl + '/api/posts/' + this.post.id, { body: this.body }).then(function (response) {
                setTimeout(function () {
...
},{"./comment-form.vue":33,"vue":30,"vue-hot-reload-api":3,"vue-strap/dist/vue-strap.min.js":28}],36:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n")
'use strict';
...
},{"./wall.vue":37,"vue":30,"vue-hot-reload-api":3,"vueify-insert-css":31}],37:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        submitPost: function submitPost() {
            ...
            this.$http.post(baseUrl + '/api/posts', { body: this.body }).then(function (response) {
        ...
        loadPosts: function loadPosts() {
            ...
            this.$http.get(this.url, { last: this.last }).then(function (response) {
    ...
    events: {
        CommentWasLiked: function CommentWasLiked(comment) {
            this.likeComment(comment);
        },
        CommentWasAdded: function CommentWasAdded(user, comment) {
...
},{"./comment-form.vue":33,"./post.vue":35,"vue":30,"vue-hot-reload-api":3}],38:[function(require,module,exports){
"use strict";
...
var _commentForm = require("./components/comment-form.vue");

var _commentForm2 = _interopRequireDefault(_commentForm);

var _comment = require("./components/comment.vue");
...
var _alerts = require("./mixins/alerts");

var _alerts2 = _interopRequireDefault(_alerts);

var _modals = require("./mixins/modals");
...
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('meta[name="csrf-token"]').getAttribute('value');
...
new _vue2.default({
    ...
    methods: {
        selectUser: function selectUser(items) {
            window.location.replace(items.username);
        },
        follow: function follow(user_id) {
            this.$http.get(baseUrl + '/api/users/' + user_id + '/follow').then(function (response) {
                var message = response.data.message;
            }.bind(this)).catch(function (response) {}.bind(this));
        },
    ...
    mixins: [_alerts2.default, _modals2.default],

    store: _store2.default
});

},{"./components/comment-form.vue":33,"./components/comment.vue":34,"./components/profile.vue":36,"./mixins/alerts":39,"./mixins/modals":40,"./vuex/store":41,"moment":1,"vue":30,"vue-resource":17,"vue-strap/dist/vue-strap.min.js":28,"vue-validator":29}],39:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        showInfoAlert: function showInfoAlert(message) {
            if (message) {
    ...
    events: {
        ...
        alertDanger: function alertDanger(message) {
            this.showDangerAlert(message);
        },
        alertInfo: function alertInfo(message) {
...
exports.default = {
    ...
    methods: {
        updateModal: function updateModal() {
            ...
            this.$http.patch(url, requestData).then(function (response) {
        ...
        showEditModalPanel: function showEditModalPanel() {
            this.modals.edit.show = true;
        }
    },

    events: {
        showCommentsModal: function showCommentsModal(model) {
            var modelType = arguments.length <= 1 || arguments[1] === undefined ? 'post' : arguments[1];
        ...
        showLikesModal: function showLikesModal(model) {
            var modelType = arguments.length <= 1 || arguments[1] === undefined ? 'post' : arguments[1];
        ...
        showEditModal: function showEditModal(model, rules) {
        ...
        CommentLiked: function CommentLiked(comment) {
